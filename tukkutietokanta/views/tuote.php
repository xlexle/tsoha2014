<div class="container">
    <div class="row">
        ...
        <form class="form-horizontal" action="tuotevalikoima.php?tallenna=<?php $tuote->getTuotenro(); ?>" method="POST">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" maxlength="25" class="form-control" id="tuotekoodi" name="koodi" value="<?php echo $tuote->getKoodi(); ?>" 
        ...
        <?php if ($data->muokkaa): { ?>
                <form class="form-horizontal" action="tuotevalikoima.php?tuotenro=<?php $tuote->getTuotenro(); ?>" method="POST">
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-4">
    ...
    <div class="row">
        <?php if (onYllapitaja() && !$data->muokkaa): { ?>
                <p><a class="btn btn-default" href = "tuotevalikoima.php?muokkaa=<?php echo $tuote->getTuotenro(); ?>">Muokkaa</a></p>
            <?php } endif; ?>
