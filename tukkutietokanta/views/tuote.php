<div class="container">
    <div class="row">
        ...
        <h2><?php if ($data->poistettu): {?>Poistettu <?php } endif; ?>Tuote <?php echo $tuote->getTuotenro();?></h2><br>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" maxlength="25" class="form-control" id="koodi" name="koodi" value="<?php echo $tuote->getKoodi();?>" 
                           <?php if (!$data->muokkaa || $data->poistettu): { ?> readonly<?php } endif; ?>>
                </div>
            </div>
            <div class="form-group">
        ...
        <?php if ($data->muokkaa): { ?>
            ...
            <form class="form-horizontal" action="tuotevalikoima.php?poista=<?php echo $tuote->getTuotenro();?>" method="POST">
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-4">
                        <button type="submit" class="btn btn-default">Poista tuote valikoimasta</button>
                    </div>
                </div>
            </form>
        <?php } elseif ($data->poistettu): {?>
            <form class="form-horizontal" action="tuotevalikoima.php?poistafinal=<?php echo $tuote->getTuotenro();?>" method="POST">
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-4">
                        <button type="submit" class="btn btn-default">Poista tuote lopullisesti</button>
                    </div>
                </div>
            </form>
        <?php } endif; ?>
