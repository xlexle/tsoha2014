            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <ul class="nav nav-tabs">
                        ...
                        <?php else:?>
                                <li <?php if ($tab==5): ?>class="active"<?php endif;?>>
                                    <a href="omasivu.php"><span class="glyphicon glyphicon-user"></span> Omat tiedot</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="col-md-1">
                    <?php $kayttaja = ""; if (onYllapitaja()) $kayttaja .= "ylläpitäjä"; else $kayttaja .= "asiakas";?>
                    <p><?php echo $kayttaja . " " . $_SESSION['kirjautunut']?> </p>
                </div>
                <div class="col-md-2">
